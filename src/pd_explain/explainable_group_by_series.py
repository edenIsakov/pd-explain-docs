...
class ExpSeriesGroupBy(SeriesGroupBy):
    ...
    def count(self):
       ...
       """
        ...
        result.name = '_'.join([result.name, 'count'])
        result.operation = GroupBy(source_df=None,
                                   source_scheme={},
    ...
    def mean(self,
        ...
        agg_attr = result.name
        result.name = '_'.join([result.name, 'mean'])
        result.operation = GroupBy(source_df=None,
                                   source_scheme={},
    ...
    def median(self, numeric_only: bool | lib.NoDefault = lib.no_default):
       ...
       """
        ...
        agg_attr = result.name
        result.name = '_'.join([result.name, 'median'])
        result.operation = GroupBy(source_df=None,
                                   source_scheme={},
                                   group_attributes=self.group_attributes,
    ...
    def std(self,
       ...
       """
        ...
        agg_attr = result.name
        result.name = '_'.join([result.name, 'std'])
        result.operation = GroupBy(source_df=None,
                                   source_scheme={},
                                   group_attributes=self.group_attributes,
    ...
    def var(
       ...
       """
        ...
        agg_attr = result.name
        result.name = '_'.join([result.name, 'var'])
        result.operation = GroupBy(source_df=None,
                                   source_scheme={},
                                   group_attributes=self.group_attributes,
    ...
    def sem(self, ddof: int = 1):
       ...
       """
        ...
        agg_attr = result.name
        result.name = '_'.join([result.name, 'sem'])
        result.operation = GroupBy(source_df=None,
                                   source_scheme={},
                                   group_attributes=self.group_attributes,
    ...
    def size(self):
       ...
       """
        ...
        agg_attr = result.name
        result.name = '_'.join([result.name, 'size'])
        result.operation = GroupBy(source_df=None,
                                   source_scheme={},
                                   group_attributes=self.group_attributes,
    ...
    def sum(
        ...
        agg_attr = result.name
        result.name = '_'.join([result.name, 'sum'])
        result.operation = GroupBy(source_df=None,
                                   source_scheme={},
                                   group_attributes=self.group_attributes,
    ...
    def prod(self, numeric_only: bool | lib.NoDefault = lib.no_default, min_count: int = 0):
        ...
        agg_attr = result.name
        result.name = '_'.join([result.name, 'prod'])
        result.operation = GroupBy(source_df=None,
                                   source_scheme={},
                                   group_attributes=self.group_attributes,
    ...
    def min(self, numeric_only: bool = False, min_count: int = -1):
        ...
        agg_attr = result.name
        result.name = '_'.join([result.name, 'min'])
        result.operation = GroupBy(source_df=None,
                                   source_scheme={},
                                   group_attributes=self.group_attributes,
    ...
    def max(self, numeric_only: bool = False, min_count: int = -1):
        ...
        agg_attr = result.name
        result.name = '_'.join([result.name, 'max'])
        result.operation = GroupBy(source_df=None,
                                   source_scheme={},
                                   group_attributes=self.group_attributes,
